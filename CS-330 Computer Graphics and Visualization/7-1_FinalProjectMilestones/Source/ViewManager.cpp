...
GLFWwindow* ViewManager::CreateDisplayWindow(const char* windowTitle)
{
	...
	// this callback is used tgo receive mouse moving events
...
void ViewManager::PrepareSceneView()
{
	...
	float min = -pow(10, g_pCamera->Zoom);
	float max = pow(10, g_pCamera->Zoom);
	...
	if (bOrthographicProjection) {
		projection = glm::ortho(-20.0f, 20.0f, -10.0f, 10.0f, -1000.0f, 1000.0f);
	}
	else {
